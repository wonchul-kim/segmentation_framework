...
class Argmax(tf.keras.layers.Layer):
    ...
    def call(self, inputs, axis=-1):
        return tf.math.argmax(inputs, axis=axis, name=self._name)
...
class AtrousSeparableConvolutionBnReLU(tf.keras.layers.Layer):
    ...
    def __init__(self, filters, kernel_size, strides=[1, 1, 1, 1], padding="SAME", data_format=None,
                 ...
                 center=True, scale=True, post_activation=None, block_name=None):
    ...
    def get_config(self):
        ...
        base_config = super(AtrousSeparableConvolutionBnReLU, self).get_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class AtrousSpatialPyramidPoolingV3(tf.keras.layers.Layer):
    ...
    def __init__(self, atrous_rates, filters):
        ...
        self.conv_bn_relu_1 = ConvolutionBnActivation(filters=filters, kernel_size=1, trainable=False)
        self.conv_bn_relu_2 = ConvolutionBnActivation(filters=filters, kernel_size=1, trainable=False)
    ...
    def get_config(self):
        ...
        config.update({
            "filters": self.filters,
            "conv_bn_relu_1":  self.conv_bn_relu_1,
            "conv_bn_relu_2":  self.conv_bn_relu_2,
            "atrous_sepconv_bn_relu_1": self.atrous_sepconv_bn_relu_1,
            "atrous_sepconv_bn_relu_2": self.atrous_sepconv_bn_relu_2,
            "atrous_sepconv_bn_relu_3": self.atrous_sepconv_bn_relu_3,
            "conv_reduction_1": self.conv_reduction_1,

        })
        base_config = super(AtrousSpatialPyramidPoolingV3, self).get_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class Upsample_x2_Add_Block(tf.keras.layers.Layer):
    ...
    def get_config(self):
        ...
        base_config = super(Upsample_x2_Add_Block, self).get_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class FPNBlock(tf.keras.layers.Layer):
    ...
    def get_config(self):
        ...
        base_config = super(FPNBlock, self).get_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class PAM_Module(tf.keras.layers.Layer):
    ...
    def get_config(self):
        ...
        base_config = super(PAM_Module, self).get_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class CAM_Module(tf.keras.layers.Layer):
    ...
    def get_config(self):
        ...
        base_config = super(CAM_Module, self).get_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class AggCF_Module(tf.keras.layers.Layer):
    ...
    def get_config(self):
        config = {
            "filters": self.filters,
            "kq_transform": self.kq_transform, 
            "value_transform": self.value_transform,
            "pooling": self.pooling, 
            "concat": self.concat, 
            "dropout": self.dropout
        }
        base_config = super(AggCF_Module, self).get_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class SpatialGather_Module(tf.keras.layers.Layer):
    ...
    def get_config(self):
        ...
        base_config = super(SpatialGather_Module, self).get_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class SpatialOCR_Module(tf.keras.layers.Layer):
    ...
    def get_config(self):
        ...
        base_config = super(SpatialOCR_Module, self).get_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class AttCF_Module(tf.keras.layers.Layer):
    ...
    def get_config(self):
        ...
        base_config = super(AttCF_Module, self).get_config()
        return dict(list(base_config.items()) + list(config.items()))
...
class HighResolutionModule(tf.keras.layers.Layer):
    ...
    def get_config(self):
        ...
        base_config = super(HighResolutionModule, self).get_config()
        return dict(list(base_config.items()) + list(config.items()))
